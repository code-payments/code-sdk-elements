...
import { CodeRequestLogin, CodeSpinner, DownloadAppQR, ErrorMessage } from '../elements';
                    ...
                    <div class="max-w-md m-auto" ref="empty">
                      ...
                      <div v-else class="delay-500">
                        ...
                        font-avenir-next-bold mb-10">
                          Scan with Code App to Login to {{ loginRequest.intent.domain }}
                        </h2>
